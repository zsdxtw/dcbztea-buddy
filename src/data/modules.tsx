  ...
  [ModuleKey.PRODUCT]: {
    ...
    menus: [
      ...
      { key: 'product-category', label: '分类管理', icon: <ProductCategoryIcon />, children: [
        { key: 'product-category-tea', label: '茶叶分类', icon: <ProductCategoryIcon /> },
        { key: 'product-category-teaware', label: '茶具分类', icon: <ProductCategoryIcon /> },
        { key: 'product-category-peripheral', label: '茶周边分类', icon: <ProductCategoryIcon /> },
        { key: 'product-category-other', label: '其他分类', icon: <ProductCategoryIcon /> },
      ] },
