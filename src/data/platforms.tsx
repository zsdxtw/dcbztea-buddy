...
export const platformItems: PlatformItem[] = [
  {
    id: 'p1', name: '京东慧采', shortName: '京东慧采', code: 'PT-JDHC',
    contactPerson: '王经理', contactPosition: '采购总监', contactPhone: '400-606-****', contactAddress: '北京市亦庄经济开发区京东总部',
  ...
  {
    id: 'p2', name: '史泰博商贸', shortName: '史泰博', code: 'PT-STB',
    contactPerson: '李主管', contactPosition: '商务经理', contactPhone: '400-820-****', contactAddress: '上海市长宁区史泰博大厦',
  ...
  {
    id: 'p3', name: '得力集团B2B', shortName: '得力', code: 'PT-DL',
    contactPerson: '陈经理', contactPosition: '渠道总监', contactPhone: '400-185-****', contactAddress: '浙江省宁波市得力工业园',
  ...
  {
    id: 'p4', name: '苏宁企业购', shortName: '苏宁', code: 'PT-SN',
    contactPerson: '周主管', contactPosition: '采购经理', contactPhone: '400-836-****', contactAddress: '江苏省南京市苏宁总部',
  ...
  {
    id: 'p5', name: '欧菲斯办公', shortName: '欧菲斯', code: 'PT-OFS',
    contactPerson: '吴经理', contactPosition: '大客户经理', contactPhone: '400-090-****', contactAddress: '重庆市渝北区欧菲斯大厦',
