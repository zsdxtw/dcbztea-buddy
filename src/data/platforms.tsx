...
export const platformItems: PlatformItem[] = [
  ...
  },
  {
    ...
    cooperationDate: '2023-08-01', commissionRate: '7%', hostId: 'emp-6', hostType: 'employee',
    bankAccounts: [
  ...
  },
  {
    ...
    cooperationDate: '2024-01-10', commissionRate: '5.5%', hostId: 'emp-7', hostType: 'employee',
    bankAccounts: [
