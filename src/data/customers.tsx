...
const directWithPlatform: CustomerItem[] = [
  ...
  { id: 'c8', name: '中信证券', shortName: '中信证券', type: 'direct', region: '深圳', province: '广东', city: '深圳市', district: '福田区', contactPerson: '周总监', contactPhone: '0755-8234****', level: 'S级', orders: 22, totalAmount: 536000, platformIds: ['p1', 'p2'], platformCommissionRates: { p1: '7%', p2: '6%' }, hostId: 'emp-6', hostType: 'employee', cooperationDate: '2022-12-01', status: 'active', settlementMethod: '月结', source: '老客户转介', remark: 'VIP客户礼品定制',
  ...
  { id: 'c9', name: '中国平安', shortName: '中国平安', type: 'direct', region: '深圳', province: '广东', city: '深圳市', district: '南山区', contactPerson: '吴经理', contactPhone: '0755-2233****', level: 'A级', orders: 10, totalAmount: 285000, platformIds: ['p4'], platformCommissionRates: { p4: '7%' }, hostId: 'emp-7', hostType: 'employee', cooperationDate: '2024-02-28', status: 'active', settlementMethod: '月结', source: '展会拓客',
  ...
  { id: 'c10', name: '招商银行', shortName: '招商银行', type: 'direct', region: '深圳', province: '广东', city: '深圳市', district: '福田区', contactPerson: '钱主管', contactPhone: '0755-8866****', level: 'B级', orders: 8, totalAmount: 196000, platformIds: ['p2'], platformCommissionRates: { p2: '6%' }, hostId: 'emp-16', hostType: 'employee', cooperationDate: '2024-05-15', status: 'active', settlementMethod: '月结', source: '主动开发',
