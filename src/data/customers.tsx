...
const directWithPlatform: CustomerItem[] = [
  { id: 'c6', name: '浦发银行', type: 'direct', region: '上海', contactPerson: '赵经理', contactPhone: '021-6123****', level: 'S级', orders: 18, totalAmount: 425000, platforms: [globalPlatforms[0]], cooperationDate: '2023-04-22', status: 'active', settlementMethod: '月结', remark: '企业福利采购，年节大宗订单' },
  { id: 'c7', name: '交通银行', type: 'direct', region: '上海', contactPerson: '孙主管', contactPhone: '021-5876****', level: 'A级', orders: 15, totalAmount: 368000, platforms: [globalPlatforms[1], globalPlatforms[2]], cooperationDate: '2023-09-10', status: 'active', settlementMethod: '月结' },
  { id: 'c8', name: '中信证券', type: 'direct', region: '深圳', contactPerson: '周总监', contactPhone: '0755-8234****', level: 'S级', orders: 22, totalAmount: 536000, platforms: [globalPlatforms[0], globalPlatforms[1]], cooperationDate: '2022-12-01', status: 'active', settlementMethod: '月结', remark: 'VIP客户礼品定制' },
  { id: 'c9', name: '中国平安', type: 'direct', region: '深圳', contactPerson: '吴经理', contactPhone: '0755-2233****', level: 'A级', orders: 10, totalAmount: 285000, platforms: [globalPlatforms[3]], cooperationDate: '2024-02-28', status: 'active', settlementMethod: '月结' },
  { id: 'c10', name: '招商银行', type: 'direct', region: '深圳', contactPerson: '钱主管', contactPhone: '0755-8866****', level: 'B级', orders: 8, totalAmount: 196000, platforms: [globalPlatforms[1]], cooperationDate: '2024-05-15', status: 'active', settlementMethod: '月结' },
];

/* ── 渠道客户 ── */
const channelCustomers: CustomerItem[] = [
  { id: 'c11', name: '天福茗茶', type: 'channel', region: '福州', contactPerson: '林经理', contactPhone: '0591-8765****', level: 'S级', orders: 56, totalAmount: 826000, platforms: [], cooperationDate: '2022-03-10', status: 'active', settlementMethod: '月结', remark: '华东区核心渠道商' },
  { id: 'c12', name: '八马茶业', type: 'channel', region: '厦门', contactPerson: '王总', contactPhone: '0592-5432****', level: 'A级', orders: 42, totalAmount: 645000, platforms: [], cooperationDate: '2023-01-18', status: 'active', settlementMethod: '月结' },
...
export const SETTLEMENT_LABELS: Record<string, string> = {
  monthly: '月结', prepaid: '预付', quarterly: '季度结算', cash: '现款',
};
