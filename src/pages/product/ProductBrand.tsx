...
const brandItems: BrandItem[] = [
  ...
  },
  {
    ...
    mainCategories: ['红茶'], productCount: 5,
  ...
  },
  {
    ...
    mainCategories: ['白茶'], productCount: 7,
  ...
  },
  {
    ...
    mainCategories: ['乌龙茶', '绿茶', '黑茶'], productCount: 8,
  ...
  },
  {
    ...
    mainCategories: ['绿茶', '花草茶'], productCount: 5,
  ...
  },
  {
    ...
    mainCategories: ['黄茶'], productCount: 3,
  ...
  },
  {
    ...
    mainCategories: ['红茶', '绿茶', '黑茶'], productCount: 9,
  ...
  },
  {
    ...
    mainCategories: ['红茶'], productCount: 4,
  ...
  },
  {
    ...
    mainCategories: ['黑茶'], productCount: 6,
  ...
  },
  {
    ...
    mainCategories: ['绿茶', '花草茶'], productCount: 3,
  ...
  return (
    <>
      ...
      <div className="content-body">
        ...
        <Card>
          <Table
            headers={['品牌LOGO', '品牌名称', '品牌编号', '品牌所属', '主营品类', '联系人', '操作']}
