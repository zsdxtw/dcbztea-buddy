          ...
          <div className="drawer-panel" onClick={e => e.stopPropagation()} style={{ width: 680 }}>
            ...
            <div className="drawer-body">
              ...
              <div style={grid2}>
                ...
                <Field label="平台编码"><Text className="mono">{detailPlatform.code}</Text></Field>
                ...
                <Field label="联系地址">{editingPlatform ? <input className="filter-input" style={{ width: '100%' }} value={editPlatformForm?.contactAddress ?? ''} onChange={e => setEditPlatformForm(prev => prev ? { ...prev, contactAddress: e.target.value } : prev)} /> : <Text>{detailPlatform.contactAddress || '—'}</Text>}</Field>
